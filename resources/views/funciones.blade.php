...
document.querySelector('#formPresupuesto').addEventListener('submit', function (e) {
  ...
  mercaderia_largo_hidden: document.getElementById('mercaderia_largo_hidden').value,
  mercaderia_alto_hidden: document.getElementById('mercaderia_alto_hidden').value,
  mercaderia_ancho_hidden: document.getElementById('mercaderia_ancho_hidden').value,
  mercaderia_peso_hidden: document.getElementById('mercaderia_peso_hidden').value,
  mercaderia_cantidad_hidden: document.getElementById('mercaderia_cantidad_hidden').value,
  mercaderia_descripcion_hidden: document.getElementById('mercaderia_descripcion_hidden').value,
  mercaderia_delicada: document.getElementById('mercaderia_delicada_hidden').value,
  mercaderia_valor_declarado_hidden: document.getElementById('mercaderia_valor_declarado_hidden').value,
